...
var Adaptor = module.exports = function Adaptor(opts) {
  ...
  if (!this.remoteOpts.port) {
    throw new Error("No websocket port specified for Remote Firmata adaptor. Cannot proceed");
  }
};
...
Adaptor.prototype.connect = function(callback) {
  this.board = new RemoteBoardHost({
    wsPort: this.remoteOpts.port,
    serialPort: this.port,
    respond: this.respond.bind(this)
  });

  this.board.on('disconnected', function() {
    throw new Error('Remote board client disconnected');
  });
